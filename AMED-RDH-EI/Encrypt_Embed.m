%将原始图像origin_I加密并嵌入数据
function [encrypt_I,stego_I,emD,hist_Map_origin_I,Map_origin_I] = Encrypt_Embed(origin_I,D,Image_key,Data_key,ref_x,ref_y,q1,q2,q3)
%% 计算origin_I的预测值
[origin_PV_I] = Predictor_Value(origin_I,ref_x,ref_y,q1,q2,q3); 
